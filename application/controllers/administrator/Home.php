...
class Home extends CI_Controller {
	...
	public function reset_link(){
		...
		if($this->form_validation->run() == FALSE) {
			...
			$user = $this->User->checkAdmin($email);	

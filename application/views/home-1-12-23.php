      ...
      <div class="row  d-flex justify-content-center">
        <div class="col-12">
          <div class="single-hero-slider-inner text-center">
            ...
            <h1 class="title" style="color:#134d47">Venus Products</h1>
            ...
            <a class="slideshow-button" href="#">shop now <i class="icon-rt-arrow-right-solid"></i></a> </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="product-slider-active product-border-box-two">
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images" > 
          ...
          <div class="single-product-item-content">
            <h6 class="sub-title txtcolor">Oils and Ointments</h6>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Keshavin Hair Oil</a></h6>
            <div class="single-product-item-price"> 200.00 &nbsp; <s>270.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> 
          ...
          <div class="single-product-item-content">
            <h6 class="sub-title txtcolor">Syrups</h6>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Dried mango</a></h6>
            <div class="single-product-item-price"> 110.00 &nbsp; <s>170.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> 
          ...
          <div class="single-product-item-content">
            ...
            <div class="single-product-item-price"> 160.00 &nbsp; <s>180.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> 
          ...
          <div class="single-product-item-content">
            <h6 class="sub-title txtcolor">Churans</h6>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Crunchy crisps</a></h6>
            <div class="single-product-item-price"> 350.00 &nbsp; <s>390.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> 
          ...
          <div class="single-product-item-content">
            ...
            <div class="single-product-item-price"> 250.00 &nbsp; <s>267.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> 
          ...
          <div class="single-product-item-content">
            ...
            <div class="single-product-item-price"> 100.00 &nbsp; <s>170.00</s> </div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="product-slider-active-grid product-border-box">
        ...
        <div class="single-product-item">
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Dried mango</a></h6>
            <div class="single-product-item-price"> 210.00 &nbsp; <s>270.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Dried banana</a></h6>
            <div class="single-product-item-price"> 360.00 &nbsp; <s>380.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Crunchy crisps</a></h6>
            <div class="single-product-item-price"> 250.00 &nbsp; <s>290.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Jewel cranberries</a></h6>
            <div class="single-product-item-price"> 160.00 &nbsp; <s>167.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Fresh Broccoli</a></h6>
            <div class="single-product-item-price"> 265.00 &nbsp; <s>278.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> <img class="primary-image" src="<?php echo  base_url(); ?>assest/frontend/images/products/product-image-4-1.jpg" alt="">  </a>
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Crunchy crisps</a></h6>
            <div class="single-product-item-price"> 333.00 &nbsp; <s>379.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
        ...
        <div class="single-product-item">
          ...
          <div class="single-product-item-content">
            ...
            <div class="single-product-item-price"> 250.00 &nbsp; <s>277.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Dried mango</a></h6>
            <div class="single-product-item-price"> 310.00 &nbsp; <s>350.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> <img class="primary-image" src="<?php echo  base_url(); ?>assest/frontend/images/products/product-image-8-1.jpg" alt="">  </a>
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Dried mango</a></h6>
            <div class="single-product-item-price"> 510.00 &nbsp; <s>570.00</s> </div>
          </div>
        </div>
        <div class="single-product-item">
          <div class="single-product-item-image"> <a href="javascript:void(0);" class="prodcut-images"> <img class="primary-image" src="<?php echo  base_url(); ?>assest/frontend/images/products/product-image-3-1.jpg" alt="">  </a>
          ...
          <div class="single-product-item-content">
            <div class="single-product-item-rating"> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid select-star"></i> <i class="icon-rt-star-solid"></i> </div>
            <h6 class="single-product-item-title"><a href="javascript:void(0);">Dried mango</a></h6>
            <div class="single-product-item-price"> 410.00 &nbsp; <s>470.00</s> </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="latest-blog-active">
        ...
        <div class="latest-blog-card">
          <div class="latest-blog-card-image"> <a href="javascript:void(0);"><img src="<?php echo  base_url(); ?>assest/frontend/images/machine/01.jpg" alt=""></a> </div>
          <div class="latest-blog-card-content text-start">
            <ul class="latest-blog-card-meta d-flex">
              <li class="post-date">Venus Products</li>
            </ul>
            <h4 class="latest-blog-card-title"><a href="javascript:void(0);">Machine Name Display Here</a></h4>
          </div>
        </div>
        <!-- Latest Blog Card End -->
        <!-- Latest Blog Card Start -->
        <div class="latest-blog-card">
          <div class="latest-blog-card-image"> <a href="javascript:void(0);"><img src="<?php echo  base_url(); ?>assest/frontend/images/machine/02.jpg" alt=""></a> </div>
          <div class="latest-blog-card-content text-start">
            <ul class="latest-blog-card-meta d-flex">
              <li class="post-date">Venus Products</li>
            </ul>
        ...
        <!-- Latest Blog Card Start -->
        <div class="latest-blog-card">
          <div class="latest-blog-card-image"> <a href="javascript:void(0);"><img src="<?php echo  base_url(); ?>assest/frontend/images/machine/03.jpg" alt=""></a> </div>
          <div class="latest-blog-card-content text-start">
            <ul class="latest-blog-card-meta d-flex">
              <li class="post-date">Venus Products</li>
            </ul>
        ...
        <!-- Latest Blog Card Start -->
        <div class="latest-blog-card">
          <div class="latest-blog-card-image"> <a href="javascript:void(0);"><img src="<?php echo  base_url(); ?>assest/frontend/images/machine/04.jpg" alt=""></a> </div>
          <div class="latest-blog-card-content text-start">
            <ul class="latest-blog-card-meta d-flex">
              <li class="post-date">Venus Products</li>
            </ul>
        ...
        <!-- Latest Blog Card End -->
        <div class="latest-blog-card">
          <div class="latest-blog-card-image"> <a href="javascript:void(0);"><img src="<?php echo  base_url(); ?>assest/frontend/images/machine/05.jpg" alt=""></a> </div>
          <div class="latest-blog-card-content text-start">
            <ul class="latest-blog-card-meta d-flex">
              <li class="post-date">Venus Products</li>
            </ul>

              ...
              <form action="javascript:;" class="cart-quantity d-flex">
                <div class="quantity">
                  <div class="cart-plus-minus">
                    <input class="cart-plus-minus-box" value="1" type="number" id="qty_btn_<?php echo $product['id']; ?>">
                  </div>
                </div>
                <button class="add-to-cart btn btn--primary md:px-5" type="button" onclick="add_to_cart(<?php echo $product['id']; ?>);">Add To Cart</button>
              </form>
            </div>
            <div class="add-to-wishlist"> <a href="javascript:;" class="add_to_wishlist"><i class="icon-rt-heart2"></i> Add to Wishlist</a> </div>

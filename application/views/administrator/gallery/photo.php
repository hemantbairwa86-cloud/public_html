                         ...
                         <?php /*?> <td><img src="<?php echo base_url(); ?>uploads/photo/<?php echo $val['image']; ?>" height="50" width="50"></td><?php */?>
                          ...
                          <td>
                            <div class="action-btn-group">
                              <a href="<?php echo base_url(); ?>administrator/gallery/edit_photo/<?php echo $val['id']; ?>" class="btn btn-sm btn-outline-primary btn-action-icon" title="Edit Photo Gallery" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>
                              <a href="javascript:void(0);" onClick="check_confirm_delete('<?php echo $val['id']; ?>');" class="btn btn-sm btn-outline-danger btn-action-icon" title="Delete Photo Gallery" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php

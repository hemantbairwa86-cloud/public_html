                 ...
                 <?php  echo form_open_multipart($action, array('id' => 'myForm','autocomplete' => 'off'));?>
                  <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                          <div class="col-md-12">
                            <input type="file" accept="image/x-png,image/gif,image/jpeg" name="image" class="file-upload-default" >
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="action-btn-group">
                              <a href="<?php echo base_url(); ?>administrator/slider/editview/<?php echo $val['id']; ?>" class="btn btn-sm btn-outline-primary btn-action-icon" title="Edit Slider" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>
                              <a href="javascript:void(0);" onClick="check_confirm_delete('<?php echo $val['id']; ?>');" class="btn btn-sm btn-outline-danger btn-action-icon" title="Delete Slider" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php

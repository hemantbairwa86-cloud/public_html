...
<html lang="en">
<head>
<title>Sales Report | <?php echo FIRM_NAME;  ?></title>
...
<page size="A4"><div>&nbsp;</div>
  <table border="1" cellpadding="0" cellspacing="0" frame="box" rules="all" align="center" width="100%" id="customers" style="line-height:22px;font-size:16px;">
    <thead>
      <tr>
        <th align="center" style="text-align:center;font-size:22px;vertical-align:middle;border-right:0;">
        <div><img src="<?php echo  base_url(); ?>assest/frontend/images/logo.svg" height="30" width="auto"></div>
        </th>        
        <th align="center" style="text-align:center;font-size:22px;vertical-align:middle;border-left:0;">
        <div style="text-align:center;padding:5px;;font-weight:bold;font-size:28px;color:#412774;font-family:Geneva, Arial, Helvetica, sans-serif">Sales Report</div>

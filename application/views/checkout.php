              ...
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="billing-details-wrap">
                    ...
                    <?php }else{ ?>
                    <form action="<?php echo base_url()."checkout/signup"; ?>" method="POST">
                    ...
                    <?php } ?>
                     ...
                     <form action="<?php echo base_url()."checkout/addaddress"; ?>" method="POST">
                        <div class="row">
                            <?php if(is_login_user_front()){ ?>
                            <div class="col-lg-12">
                              <div class="your-order-wrap">
                                ...
                                <div class="ship-box-info">
                                  <div class="row">
                                    <div class="col-lg-12">
                                      <p class="single-form-row">
                                        <label>Address <span class="required">*</span></label>
                                        <input type="text" name="address_extra" required value="<?php echo $address_extra; ?>">
                                    ...
                                    <div class="col-lg-12">
                                      <p class="single-form-row">
                                        <label>Landmark <span class="required">*</span></label>
                                        <input type="text" name="landmark_extra" required value="<?php echo $landmark_extra; ?>">
                                    ...
                                    <div class="col-lg-6">
                                      <div class="single-form-row">
                                        <label>Country <span class="required">*</span></label>
                                        <div class="nice-select wide">
                                         <input type="text" name="country_extra" required value="India" readonly>
                                          <?php /*?><select id="country_extra" name="country_extra" required onChange="get_states_extra(this.value);">
                                    ...
                                    <div class="col-lg-6">
                                      <div class="single-form-row">
                                        <label>State <span class="required">*</span></label>
                                        <div class="nice-select wide">
                                          <select id="state_extra" name="state_extra" required onChange="get_shiping_charge(this.value);">
                                            <option value="">Select</option>
                                          </select>
                                    ...
                                    <div class="col-lg-6">
                                      <p class="single-form-row">
                                        <label>City <span class="required">*</span></label>
                                        <input type="text" name="city_extra" required value="<?php echo $city_extra; ?>">
                                    ...
                                    <div class="col-lg-6">
                                      <p class="single-form-row">
                                        <label>Pincode <span class="required">*</span></label>
                                        <input type="text" name="pincode_extra" required value="<?php echo $pincode_extra; ?>">
                        ...
                        <div class="cart-page-total mt-4">
                          <ul>
                            ...
                            { 
                                ...
                                if($billing_address['state']==12 && $total>=499)
                                {
                                    $shipping_charge=0;
                                }else{
                           ...
                           <?php } 
                           $org_tot = $total;
                           $final_total = $total+$shipping_charge-$dis;
                           ?>
                          ...
                          <div class="payment-method">
                            <div class="order-button-payment mb-4">
                              <?php
                              $surl = base_url().'phonepay/success';
                              $furl =base_url().'phonepay/failed';
                              $amount = $final_total;
                              $return_url = base_url().'phonepay/callback_pay';
                              ?>
                                <form name="phonepay-form" id="phonepay-form" action="<?php echo $return_url; ?>" method="POST">                            
                                <?php if(is_login_user_front()){ ?>
                                  <input type="hidden" name="name" value="test">
                                    <input id="submit-pay" type="submit" value="Place order" />
                                <?php } ?>
                                </form>
                            </div>
                          </div>

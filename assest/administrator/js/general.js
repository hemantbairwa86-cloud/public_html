...
function AddMoreExtraField() {
  ...
  var extrafields = '<div class="row"  id="extrafields"><input type="hidden" name="extra_edit_id[]" value="0">';
        ...
        extrafields +='<div class="col-md-2">';
          extrafields +='<div class="form-group">';
            extrafields +='<br>';
            extrafields +='<button type="button" class="btn btn-danger btn-sm mr-2" id="RemoveExtraField">';
              extrafields +='<i class="fa fa-remove"  style="margin-right:0px;"></i>';
            extrafields +='</button>';
        extrafields +='</div>';
      extrafields +='</div>';
      extrafields +='</div>';
